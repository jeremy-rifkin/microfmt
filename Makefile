...
debug:  ## build in debug mode
	cmake -S . -B build -GNinja -DCMAKE_BUILD_TYPE=Debug -DCMAKE_EXPORT_COMPILE_COMMANDS=On -DMICROFMT_BUILD_TESTING=On
	cmake --build build

.PHONY: release
release:  ## build in release mode
	cmake -S . -B build -GNinja -DCMAKE_BUILD_TYPE=Release -DCMAKE_EXPORT_COMPILE_COMMANDS=On -DMICROFMT_BUILD_TESTING=On
	cmake --build build

.PHONY: debug-msvc
debug-msvc:  ## build in debug mode
	cmake -S . -B build -DCMAKE_EXPORT_COMPILE_COMMANDS=On -DMICROFMT_BUILD_TESTING=On
	cmake --build build --config Debug

.PHONY: release-msvc
release-msvc:  ## build in release mode
	cmake -S . -B build -DCMAKE_EXPORT_COMPILE_COMMANDS=On -DMICROFMT_BUILD_TESTING=On
